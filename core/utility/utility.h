...
//std::map<std::string, int> DHP19_TO_COCO_INDICES;
//DHP19_TO_COCO_INDICES["head"]=0;  // no head in coco, use nose
//DHP19_TO_COCO_INDICES["shoulderR"]=2;
//DHP19_TO_COCO_INDICES["shoulderL"]=5;
//DHP19_TO_COCO_INDICES["elbowR"]=3;
//DHP19_TO_COCO_INDICES["elbowL"]=6;
//DHP19_TO_COCO_INDICES["hipL"]=11;
//DHP19_TO_COCO_INDICES["hipR"]=8;
//DHP19_TO_COCO_INDICES["handR"]=4;  // no right hand in coco, use right wrist
//DHP19_TO_COCO_INDICES["handL"]=7;  // no left hand in coco, use left wrist
//DHP19_TO_COCO_INDICES["kneeR"]=9;
//DHP19_TO_COCO_INDICES["kneeL"]=12;
//DHP19_TO_COCO_INDICES["footR"]=10;  // no right foot in coco, use right ankle
//DHP19_TO_COCO_INDICES["footL"]=13;  // no left foot in coco, use left ankle
...
inline skeleton coco_to_dhp19(const skeleton skeleton_in)
{
    skeleton skeleton_out;

    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::head_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::head_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::shoulderR_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::shoulderR_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::shoulderL_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::shoulderL_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::elbowR_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::elbowR_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::elbowL_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::elbowL_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::hipL_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::hipL_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::hipR_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::hipR_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::handR_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::handR_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::handL_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::handL_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::kneeR_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::kneeR_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::kneeL_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::kneeL_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::footR_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::footR_coco))));
    skeleton_out.push_back(std::make_tuple(std::get<0>(skeleton_out.at(DHP19_TO_COCO_INDICES::footL_coco)), std::get<1>(skeleton_out.at(DHP19_TO_COCO_INDICES::footL_coco))));

...
rootCodeFolder = '/home/fdipietro/projects/hpe-core/evaluation/matlab'; % root directory of the git repo.
rootDataFolder = '/mnt/0058555E5855540E'; % root directory of the data downloaded from resiliosync.
outDatasetFolder = '/home/fdipietro/hpe-data';
...
if(true)
    ...
    cd(outFolder);
    saveCams(cam, X, y, timeStamp, pol, startIndex, stopIndex, startTime, stopTime, outFile_string);
